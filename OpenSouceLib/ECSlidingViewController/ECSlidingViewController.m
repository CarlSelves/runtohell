...
- (void)updateTopViewHorizontalCenterWithRecognizer:(UIPanGestureRecognizer *)recognizer
{
  ...
  else if (recognizer.state == UIGestureRecognizerStateChanged)
  {
    ...
    {
      CGFloat panAmount = self.initialTouchPositionX - currentTouchPositionX;//delta x
...
- (void)topViewHorizontalCenterWillChange:(CGFloat)newHorizontalCenter
{
  ...
  //from right through center, left view will disappear
  ...
  //from left through center, right view will disappear
  if (center.x <= self.resettedCenter && newHorizontalCenter == self.resettedCenter) {
		dispatch_async(dispatch_get_main_queue(), ^{
  ...
  //underLeftWillAppear and underRightWillAppear method is use to update some flag..
    
  //from left/center through right, left view will appear
  if (center.x <= self.resettedCenter && newHorizontalCenter > self.resettedCenter) {
    [self underLeftWillAppear];
  }//from right/center through left, right view will appear
